 ...
 */
/*
define("DB_USER", 'id11856978_rutas_baique');
define("DB_PASSWORD", 'roke3215569231');
define("DB_NAME", 'id11856978_rutas_baique');
define("DB_HOST", 'localhost');
define("BACKUP_DIR", 'BACKUP'); // Comment this line to use same script's directory ('.')
define("TABLES", 'colegio, conductor, coordenadas, resultadoruta, ruta, varada'); // Full backup
...
class Backup_Database
{
    ...
    public function __construct($host, $username, $passwd, $dbName, $charset = 'utf8')
    {
        ...
        $this->backupFile              = $this->dbName . '-' . date("d-m-Y_H--i--s", time()) . '.sql';
